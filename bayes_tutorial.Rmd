...
## Draw samples from 
samples<-coda.samples(jags, variable.names = c("a", "beta"), 
                      n.iter=1000,
                      nchain=4)
```
...
### 2.4 How Non-convergence Might Look Like
...
And let's compile it, sample from the posterior distributions of the parameters, and plot hthe samples.
```{r warning=FALSE, message=FALSE}
model.spec<-textConnection(code)
